...
import com.web.hackathon.service.EmailService;
...
public class EmailController {
    ...
    @ApiOperation(value = "${EmailController.sendVerifyCodeByEmail}", response = ResponseEntity.class)
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "${EmailController.verifyCode}", response = EmailConfirmation.class)
    @ApiResponses(value = {
            @ApiResponse(code = 400, message = "Something went wrong"),
            @ApiResponse(code = 403, message = "Access denied"),
